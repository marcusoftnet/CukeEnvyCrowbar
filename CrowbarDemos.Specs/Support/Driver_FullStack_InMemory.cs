using CrowbarDemos.Specs.Support.Builders;
using CrowbarDemos.Specs.Support.Wrappers;
...
namespace CrowbarDemos.Specs.Support
{
    public class Driver_FullStack_InMemory
    {
        ...
        private readonly BankControllerWrapper _bankModuleWrapper;
        ...
        public Driver_FullStack_InMemory(InMemoryCashDispenser cashDispenser, AccountBuilder accountBuilder)
        {
            ...
            _bankModuleWrapper = new BankControllerWrapper(_cashDispenser);
        }
